 ...
 */
public class GetServiceIncidents extends BasePartnerScenario 
{
    /**
     * Initializes a new instance of the {@link #GetServiceIncidents} class.
     * 
    ...
    protected void runScenario() 
    {
        ...
        this.getContext().getConsoleHelper().startProgress("Retrieving service incidents");
